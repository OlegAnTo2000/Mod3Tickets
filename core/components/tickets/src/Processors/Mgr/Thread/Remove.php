...
class TicketThreadRemoveProcessor extends MODX\Revolution\Processors\Model\RemoveProcessor
{
	/** @var TicketThread */
	public $object;
	...
	{
		$comments = $this->modx->getIterator('TicketComment', ['thread' => $this->object->get('id')]);
