...
class TicketCommentsGetListProcessor extends GetListProcessor
{
    ...
    public function prepareQueryBeforeCount(xPDOQuery $c)
    {
        ...
        if ($section = (int)$this->getProperty('section')) {
            if ($section = $this->modx->getObject('MODX\Revolution\modResource', $section)) {
        ...
        $c->leftJoin('MODX\Revolution\modUser', 'User');
        $c->leftJoin('MODX\Revolution\modUserProfile', 'UserProfile');
        $c->leftJoin('MODX\Revolution\modResource', 'Resource', 'Thread.resource = Resource.id');
        $c->select($this->modx->getSelectColumns('Tickets\Model\TicketComment', 'Tickets\Model\TicketComment'));
        $c->select(array(
            'Thread.resource',
            'Thread.properties',
