<li class="ticket-comment{$comment_new ?: ''}" id="comment-{$id}" 
data-parent="{$parent}"
data-newparent="{$new_parent}"
data-id="{$id}">
		...
		<div class="ticket-comment-header">
			...
			<span class="ticket-comment-rating{$can_vote ?: ''}{$cant_vote ?: ''}">
				<span class="rating{$rating_positive ?: ''}{$rating_negative ?: ''}"
					title="{$_modx->lexicon('ticket_rating_total')} {$rating_total ?: ''}: ↑{$rating_plus ?: ''} {$_modx->lexicon('ticket_rating_and')} ↓{$rating_minus ?: ''}">{$rating ?: ''}</span>
				<span class="vote plus{$voted_plus ?: ''}" title="{$_modx->lexicon('ticket_like')}"><i
	...
	<div class="comment-reply">
		<a href="#" class="reply">{$_modx->lexicon('ticket_comment_reply')}</a>
		{$comment_edit_link ?: ''}
	</div>
	<ol class="comments-list">{$children ?: ''}</ol>
</li>
<!--tickets_comment_edit_link <a href="#" class="edit">{$_modx->lexicon('ticket_comment_edit')}</a>-->
<!--tickets_comment_was_edited <span class="ticket-comment-edited">({$_modx->lexicon('ticket_comment_was_edited')})</span>-->
