    ...
    <form id="comment-form" action="" method="post" class="well">
        ...
        <div class="form-group">
            ...
            <span class="error" id="text-error"></span>
				...
				{if $allowFiles == 1}
					{$_modx->lexicon('ticket_comment_upload_auth')}
				{/if}

        {$captcha ?: ''}

        <div class="form-actions">
            <input type="button" class="btn btn-default preview" value="{$_modx->lexicon('ticket_comment_preview')}"
							title="Ctrl + Enter"/>
            <input type="submit" class="btn btn-primary submit" value="{$_modx->lexicon('ticket_comment_save')}"
