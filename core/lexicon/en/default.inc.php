...
$_lang['tickets_section_rating_min_ticket_create']       = 'The rating for the ticket';
$_lang['tickets_section_rating_min_ticket_create_desc']  = 'Minimum rating needed to create a ticket in this section.';
$_lang['tickets_section_rating_days_ticket_vote']        = 'Vote for the ticket';
$_lang['tickets_section_rating_days_ticket_vote_desc']   = 'The maximum number of days after the publication of the ticket, during which users can vote for it.';
$_lang['tickets_section_rating_min_comment_create']      = 'The rating for the comment';
$_lang['tickets_section_rating_min_comment_create_desc'] = 'Minimum rating needed to create a comment in this section.';
$_lang['tickets_section_rating_days_comment_vote']       = 'Vote for comment';
$_lang['tickets_section_rating_days_comment_vote_desc']  = 'The maximum number of days after the publication of the comment, during which users can vote for it.';
...
$_lang['tickets_action_reply']       = 'Reply';
$_lang['tickets_action_unpublish']   = 'UnPublish';
$_lang['tickets_action_unsubscribe'] = 'UnSubscribe';
