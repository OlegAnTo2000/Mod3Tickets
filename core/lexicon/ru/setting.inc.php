...
$_lang['setting_tickets.date_format']                      = 'Формат даты';
$_lang['setting_tickets.date_format_desc']                 = 'Формат вывода даты в оформлении тикетов.';
...
$_lang['setting_tickets.allow_markdown_in_comments']      = 'Разрешить использование markdown в комментариях';
$_lang['setting_tickets.allow_markdown_in_comments_desc'] = 'Если true, позволяет использовать markdown в комментариях.';
$_lang['setting_tickets.allow_markdown_in_tickets']      = 'Разрешить использование markdown в тикетах';
$_lang['setting_tickets.allow_markdown_in_tickets_desc'] = 'Если true, позволяет использовать markdown в тикетах.';
...
$_lang['setting_mgr_tree_icon_ticketssection']      = 'Иконка секции тикетов';
$_lang['setting_mgr_tree_icon_ticketssection_desc'] = 'Иконка оформления секции с тикетами в дереве ресурсов.';
