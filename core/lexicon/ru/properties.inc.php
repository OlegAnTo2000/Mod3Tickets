...
$_lang['tickets_prop_TicketsInit'] = 'Установить 1 для подключения формы подписки и инциализации frontend-скриптов Tickets на произвольных страницах сайта';
$_lang['tickets_prop_createdby']   = 'ID автора (user), на которого будет осуществляться подписка через форму';
